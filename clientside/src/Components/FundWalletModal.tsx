...
const FundWalletModal: React.FC<FundWalletModalProps> = ({ handleModalClose, walletAddress }) => {
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20'>
      <div className='bg-primary-100 p-6 rounded-lg shadow-4xl w-full max-w-md'>
        ...
        <div className='flex justify-end'>
          <Button className='bg-blue-500 text-white py-2 px-4 rounded' onClick={handleModalClose}>
            Close
          </Button>
        </div>
      </div>
